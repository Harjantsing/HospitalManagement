...
import LoginOptionsTY from "screens/LoginOptionsTY";
  ...
  return (
    <AppContainer>
      <Router>
        ...
        <Route exact path="/TY-login" component={LoginOptionsTY} />
        <Route exact path="/covid19" component={CovidScreen} />
        <Route exact path="/life-care/medicines" component={MedicineScreen} />
